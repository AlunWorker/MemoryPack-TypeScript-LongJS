...
const unixEpochTicks = Long.fromValue("621355968000000000");

// 01-62 bit represents ticks
// 63-64 bit represents DateTimeKind(we trim kind)
const dateTimeMask = Long.fromValue("4611686018427387903");
...
export class MemoryPackWriter {
    ...
    public writeInt64(value: Long): void {
        ...
        this.dataView.setInt32(this.offset, value.low, true);
        this.dataView.setInt32(this.offset + 4, value.high, true);
        this.offset += 8;
    }

    public writeNullableInt64(value: Long | null): void {
        if (value == null) {
            this.clearBuffer(16);
            return;
        }

        this.writeInt64(Long.fromValue(1));
        this.writeInt64(value);
    }

    public writeUint64(value: Long): void {
        this.ensureCapacity(8);
        this.dataView.setUint32(this.offset, value.low, true);
        this.dataView.setUint32(this.offset + 4, value.high, true);
        this.offset += 8;
    }

    public writeNullableUint64(value: Long | null): void {
        if (value == null) {
            this.clearBuffer(16);
            return;
        }

        this.writeUint64(Long.fromValue(1));
    ...
    public writeDate(value: Date): void {
        ...
        const unixMillisecond = Long.fromValue(value.getTime());
        const ticks = unixMillisecond.mul(10000).add(unixEpochTicks);
        this.writeUint64(ticks.and(dateTimeMask));
    }
