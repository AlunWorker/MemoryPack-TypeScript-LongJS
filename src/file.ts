...
import {MemoryPackReader} from "./memorypack/MemoryPackReader";
import {AllConvertableType} from "./memorypack/AllConvertableType";
import {NoMarkByteEnum} from "./memorypack/NoMarkByteEnum";
import {NumberedUShortEnum} from "./memorypack/NumberedUShortEnum";
import {NestedObject} from "./memorypack/NestedObject";
import {IMogeUnion} from "./memorypack/IMogeUnion";
import {SampleUnion1} from "./memorypack/SampleUnion1";
import {Subset} from "./memorypack/Subset";
import {SampleUnion2} from "./memorypack/SampleUnion2";
import {Person} from "./memorypack/Person";
import {Gender} from "./memorypack/Gender";
...
export async function hoge() {
    ...
    person.id = "111";//crypto.randomUUID();
    person.age = 30;
...
export async function huga() {
    ...
    person1.id = "111";//crypto.randomUUID();
    person1.age = 30;
    ...
    person2.id = "111";//crypto.randomUUID();
    person2.age = 430;
...
export async function test() {
    ...
    v.myShort = -1000;
    v.myInt = 99999;
    v.myLong = Long.fromValue("2124141414999");
    v.myUShort = 43141;
    v.myUInt = 400000;
    v.myULong = Long.fromValue(243242);
    v.myFloat = 31413.431251;
    v.myDouble = 9932.425252;
    // v.myGuid = "111";//crypto.randomUUID();
    v.myDate = date;
    ...
    v.dictCheck3.set("111", 100);
    // v.dictCheck3.set(crypto.randomUUID(), null);
    v.dictCheck3.set("111", null);
    ...
    //
    //
    // const response = await fetch("http://localhost:5260/api/", {
    //     method: "POST",
    //     body: blob,
    ...
    //     return;
    // }
    const buffer = bin.buffer;//await response.arrayBuffer();
...
export async function test2() {
    ...
    v.nullMyShort = -1000;
    v.nullMyInt = 99999;
    v.nullMyLong = Long.fromValue("2124141414999");
    v.nullMyUShort = 43141;
    v.nullMyUInt = 400000;
    v.nullMyULong = Long.fromValue(243242);
    v.nullMyFloat = 31413.431251;
    v.nullMyDouble = 9932.425252;
    // v.nullMyGuid = "111";// crypto.randomUUID();
    v.nullMyDate = date;
